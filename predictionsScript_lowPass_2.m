...
%% Create low pass equiripple filter

d = designfilt('lowpassfir', ...
    'PassbandFrequency',0.0015,'StopbandFrequency',0.0055, ...
...
for i = 1:5
    ...
    filtered_1_test(i, :) = filtfilt(d, test_prediction_1(i, :));
    
    for j=1:147500
        
        if test_prediction_1(i, j) > 0.7
...
for i = 1:5
    ...
    filtered_2_test(i, :) = filtfilt(d, test_prediction_2(i, :));
    
    for j=1:147500
        
        if test_prediction_2(i, j) > 0.7
...
for i = 1:5
    ...
    filtered_3_test(i, :) = filtfilt(d, test_prediction_3(i, :));
    
    for j=1:147500
        
        if test_prediction_3(i, j) > 0.7
